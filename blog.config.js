// 注: process.env.XX是Vercel的环境变量，配置方式见：https://jiangnanxiaohe.com/
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '创业的坑，我都踩过，创业的路，我们一起走🏆',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '江南小和', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '创业的坑，我都踩过，创业的路，我们一起走🏆', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiangnanxiaohe.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '江南小和, 江南小和博客,创业,分享资源,资源,教程,创业指南,热门科技,互联网,独立站,工厂,创客联盟,心得分享', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@jiangnanxiaohe.com', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2024680号', // 备案号 闽ICP备XXXXXXX
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-N8H0XQVXN8', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  IMG_LAZY_LOAD_PLACEHOLDER:
    ...
    'https://s.nmxc.ltd/sakurairo_vision/@2.6/load_svg/outload.svg', // 懒加载占位图片地址，支持base64或url
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '江南小和', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录生活，分享资源', // 站点描述，被notion中的页面描述覆盖
