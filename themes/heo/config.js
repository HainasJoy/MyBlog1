const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-12-05', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '更多干货，请搜索关键字/词', url: 'https://jiangnanxiaohe.com' },
    { title: 'Ctrl＋D收藏本站不迷路', url: 'https://jiangnanxiaohe.com' }
  ],
  ...
  HEO_HERO_TITLE_4: '共创空间，共享智慧👋',
  HEO_HERO_TITLE_5: '生活明朗 万物可爱',
  HEO_HERO_TITLE_LINK: 'https://jiangnanxiaohe.com',
  // 英雄区遮罩文字
  ...
  HEO_SOCIAL_CARD_TITLE_1: '公众号了解更多',
